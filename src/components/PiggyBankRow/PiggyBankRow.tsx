			...
			<td>
				<div className={style.action}>
					...
					<div className={state ? style.modal : style.modal_off}>
						<button onClick={() => _sellPiglets()} type='button' className={style.modal__button}>
							Sell
						</button>
						<hr />
						<button onClick={() => _compound()} type='button' className={style.modal__button}>
							compound
						</button>
						<hr />
						<button onClick={() => openDepositModal()} type='button' className={style.modal__button}>
							Deposit
						</button>
					</div>
				</div>
